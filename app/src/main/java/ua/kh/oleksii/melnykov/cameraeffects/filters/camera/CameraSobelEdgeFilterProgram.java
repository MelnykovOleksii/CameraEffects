 ...
 * @version 1.0
 */
public class CameraSobelEdgeFilterProgram extends FilterBaseProgram {
    ...
    public CameraSobelEdgeFilterProgram() {
        mLineSize = 1f;
    }
    ...
    protected String getShader() {
        return "#extension GL_OES_EGL_image_external : require\n" +
                ...
                "" +
                "   float bottomLeftIntensity = texture2D(sTexture, mLeftTextureCoordinate).r;\n" +
